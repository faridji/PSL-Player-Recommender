...
def suplementary_pick():
    ...
    for index_1, player in suplementary_pick.iterrows():
        suplementary_pick.loc[index_1, 'Category'] = 'Suplementary'
    ...
    """ Now updating Best 20 in DB """
    insert_specific_record('best_20', suplementary_pick)
...
def recommended_Player_For_Selection_Suplementary():
    ...
    platinum = platinum.sort(['Overall_rating'], ascending=[False])
    ...
    diamond = diamond.sort(['Overall_rating'], ascending=[False])
    ...
    gold = gold.sort(['Overall_rating'], ascending=[False])
    ...
    silver = silver.sort(['Overall_rating'], ascending=[False])
...
if sys.argv[1] == 'supplementoryPick':
    suplementary = suplementary_pick()
